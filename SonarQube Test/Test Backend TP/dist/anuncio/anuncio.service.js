...
exports.AnuncioService = void 0;
const common_1 = require("@nestjs/common");
const typeorm_1 = require("@nestjs/typeorm");
const typeorm_2 = require("typeorm");
const anuncio_entity_1 = require("./anuncio.entity");
const uuid_1 = require("uuid");
let AnuncioService = class AnuncioService {
    constructor(anuncioRepository) {
...
AnuncioService = __decorate([
    common_1.Injectable(),
    __param(0, typeorm_1.InjectRepository(anuncio_entity_1.AnuncioEntity)),
    __metadata("design:paramtypes", [typeorm_2.Repository])
], AnuncioService);
exports.AnuncioService = AnuncioService;
