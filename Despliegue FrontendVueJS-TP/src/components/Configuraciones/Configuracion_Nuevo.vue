...
export default {
  ...
  created() {
    ...
    this.idconfiguracion = this.$store.state.tipo_configuracion_id;
  },
  methods: {
    ...
    returnToList() {
      this.$router.push("/configuraciones/" + this.cadena);
    },
    guardar(){
        this.cargando = true;
        this.validInsertion = false;
        axios.post("/configuracion",
         {
