  ...
  <v-layout align-start>
    <v-flex>
      ...
      <v-data-table
        ...
        :loading="cargandoAmenities || cargandoEliminacion" :loading-text="textoCargando"
      >
...
export default {
  ...
  data() {
    return {
      ...
      textoCargando:"Cargando amenities",
      reglaEditNombre: [
  ...
  methods: {
    crearNuevo() {
     this.$router.push("/amenities/" + this.cadena + "/nuevo");
    },
    verDetalle(item) {
    //  this.$router.push(
       // "/amenities/" + this.cadena + "/" + item.idservicio + "/detalle"
     // );
    },
    volverAmenities() {
    ...
    listar(){
      ...
      axios.get("/amenitie/tipo-amenitie/" + this.idgrupo_contenido)
      .then(response => {
    ...
    abrirDialogoEdicion(item){
        this.amenitie.id = item.id;
        this.amenitie.nombre = item.nombre;
        this.amenitie.descripcion = item.descripcion;
        this.amenitie.clima = item.clima;
    ...
    eliminar(){
      ...
      axios.delete("amenitie/" + this.amenitie.id)
      .then(response => {
